...
$current = array('color' => $result['color'], 'emissions' => array('amount' => $result['gramm'], 'unit' => 'g CO₂ / KWh'), 'label' => array('singular' =>  $result['name'], 'plural' =>  $result['name_plural']), 'time' => 'Jetzt');
